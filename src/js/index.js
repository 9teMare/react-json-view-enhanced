...
import AddItemRequest from './components/ArrayItemModal/AddItemRequest';
...
class ReactJsonView extends React.PureComponent {
    constructor(props) {
        ...
        this.state = {
            ...
            typeInvalidMessage: ReactJsonView.defaultProps.typeInvalidMessage,
    ...
    static defaultProps = {
        ...
        fixedType: false,
        typeInvalidMessage: "Invalid value type"
    };
    ...
    static getDerivedStateFromProps(nextProps, prevState) {
        if (
            ...
            const newPartialState = {
                ...
                typeInvalidMessage: nextProps.typeInvalidMessage,
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if (prevState.addItemRequest !== false) {
            this.setState({
                addItemRequest: false
            });
        }
    ...
    getListeners = () => {
        return {
            ...
            'add-item-request': this.addItemRequest,
            'variable_type_invalid': this.showTypeInvalidMessage
        };
    };
