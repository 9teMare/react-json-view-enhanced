    ...
    handleAction = action => {
        ...
        switch (name) {
            ...
            case 'ADD_VARIABLE_KEY_REQUEST':
                ...
                break;
            case 'ADD_VARIABLE_ITEM_REQUEST':
                this.set(rjvId, 'action', 'new-item-request', data);
                this.emit('add-item-request-' + rjvId);
                break;
            case 'VARIABLE_TYPE_INVALID':
                this.set(rjvId, 'action', 'variable_type_invalid', {
                    type: 'variable_type_invalid'
                });
                this.emit('variable_type_invalid-' + rjvId);
                break;
        }
    };
